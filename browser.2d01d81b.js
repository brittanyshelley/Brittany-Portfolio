...
})({"iaE92":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "8b43a6cf2d01d81b";
...
},{}],"anKWJ":[function(require,module,exports) {
...
async function loadParticlesLinksInteraction(engine, refresh = true) {
    const { loadLinksInteraction  } = await require("e3b0868694771997"), { loadLinksPlugin  } = await require("163308c5c840f73d");
    await loadLinksInteraction(engine, refresh);
    await loadLinksPlugin(engine, refresh);
}

},{"e3b0868694771997":"6IQro","163308c5c840f73d":"fYHGU","./Options/Classes/Links.js":"brvKu","./Options/Classes/LinksShadow.js":"ehpbZ","./Options/Classes/LinksTriangle.js":"30pWz","./Options/Interfaces/ILinks.js":"ixaXp","./Options/Interfaces/ILinksShadow.js":"70JJN","./Options/Interfaces/ILinksTriangle.js":"5JDwG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6IQro":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("bXiCM") + "interaction.62629b1f.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("4zrcu"));

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}],"fYHGU":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("bXiCM") + "plugin.df29e97d.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("r7UPr"));

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}],"brvKu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iaE92"], null, "parcelRequire6158")

//# sourceMappingURL=browser.2d01d81b.js.map
