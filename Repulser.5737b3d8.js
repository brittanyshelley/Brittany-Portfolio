...
})({"1zgqZ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "05bde9275737b3d8";
...
},{}],"k8sRC":[function(require,module,exports) {
    ...
    constructor(engine, container){
        ...
        this._clickRepulse = ()=>{
            ...
            if (repulse.clicking) {
                ...
                for (const particle1 of repulse.particles)particle1.velocity.setTo(particle1.initialVelocity);
                repulse.particles = [];
            }
        };
        this._hoverRepulse = ()=>{
        ...
        this._singleSelectorRepulse = (selector, div)=>{
            ...
            query.forEach((item)=>{
                ...
                }, repulseRadius = elem.offsetWidth * half * pxRatio, area = div.type === "circle" ? new (0, _engine.Circle)(pos.x, pos.y, repulseRadius) : new (0, _engine.Rectangle)(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio), divs = repulse.divs, divRepulse = (0, _engine.divMode)(divs, elem);
...
},{"@tsparticles/engine":"ahMVX","./Options/Classes/Repulse.js":"5vnl7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1zgqZ"], null, "parcelRequire6158")

//# sourceMappingURL=Repulser.5737b3d8.js.map
