...
})({"gAB8q":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f097dc60ce51f428";
...
},{}],"kOghc":[function(require,module,exports) {
    ...
    if ((0, _engine.getDistance)(begin, end) <= maxDistance) {
        ...
        if (d1.distance <= maxDistance) {
            ...
            if (d2.distance <= maxDistance) {
                const yi1 = begin.y - d2.dy / d2.dx * begin.x;
                const xi = -yi1 / (d2.dy / d2.dx);
                pi1 = {
                    x: xi,
                    y: 0
                };
                ...
                if (d3.distance <= maxDistance) {
                    const yi2 = begin.y - d3.dy / d3.dx * begin.x;
                    const xi1 = -yi2 / (d3.dy / d3.dx);
                    pi1 = {
                        x: xi1,
                        y: yi2
                    };
...
},{"@tsparticles/engine":"ahMVX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gAB8q"], null, "parcelRequire6158")

//# sourceMappingURL=LinkInstance.ce51f428.js.map
