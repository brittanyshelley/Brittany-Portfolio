...
})({"2ByTg":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c6fbd6a53eecb158";
...
},{}],"l15qL":[function(require,module,exports) {
...
class OutOfCanvasUpdater {
    ...
    init(particle) {
        ...
        if (checkOutMode(outModes, "bounce")) this.updaters.push(new (0, _bounceOutModeJs.BounceOutMode)(this.container));
        else if (checkOutMode(outModes, "out")) this.updaters.push(new (0, _outOutModeJs.OutOutMode)(this.container));
        else if (checkOutMode(outModes, "destroy")) this.updaters.push(new (0, _destroyOutModeJs.DestroyOutMode)(this.container));
        else if (checkOutMode(outModes, "none")) this.updaters.push(new (0, _noneOutModeJs.NoneOutMode)(this.container));
    }
    isEnabled(particle) {
...
function bounceHorizontal(data) {
    if (data.outMode !== "bounce" && data.outMode !== "split" || data.direction !== "left" && data.direction !== "right") return;
    if (data.bounds.right < boundsMin && data.direction === "left") data.particle.position.x = data.size + data.offset.x;
    ...
    else if (data.bounds.left <= boundsMin && data.direction === "left") data.particle.position.x = minPos;
    if (data.outMode === "split") data.particle.destroy();
}
function bounceVertical(data) {
    if (data.outMode !== "bounce" && data.outMode !== "split" || data.direction !== "bottom" && data.direction !== "top") return;
    if (data.bounds.bottom < boundsMin && data.direction === "top") data.particle.position.y = data.size + data.offset.y;
    ...
    else if (data.bounds.top <= boundsMin && data.direction === "top") data.particle.position.y = minPos;
    if (data.outMode === "split") data.particle.destroy();
}
                    ...
                    case "outside":
                        {
                            ...
                            const { dx: dx1 , dy: dy1  } = (0, _engine.getDistances)(particle.position, particle.moveCenter);
...
},{"@tsparticles/engine":"ahMVX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2ByTg"], null, "parcelRequire6158")

//# sourceMappingURL=OutOfCanvasUpdater.3eecb158.js.map
