...
})({"lX4ev":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "71a492e9ffd5e16a";
...
},{}],"kAOlz":[function(require,module,exports) {
...
class Attractor extends (0, _engine.ExternalInteractorBase) {
    ...
    interact() {
        ...
        if (mouseMoveStatus && hoverEnabled && (0, _engine.isInArray)(attractMode, hoverMode)) (0, _utilsJs.hoverAttract)(this.container, (p)=>this.isEnabled(p));
        else if (clickEnabled && (0, _engine.isInArray)(attractMode, clickMode)) (0, _utilsJs.clickAttract)(this.container, (p)=>this.isEnabled(p));
    }
    isEnabled(particle) {
...
},{"@tsparticles/engine":"ahMVX","./Utils.js":"ffEG6","./Options/Classes/Attract.js":"9j4pK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ffEG6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function processAttract(container, position, attractRadius, area, queryCb) {
    ...
    for (const particle of query){
        const { dx , dy , distance  } = (0, _engine.getDistances)(particle.position, position), velocity = attractOptions.speed * attractOptions.factor, attractFactor = (0, _engine.clamp)((0, _engine.getEasing)(attractOptions.easing)(identity - distance / attractRadius) * velocity, minFactor, attractOptions.maxSpeed), normVec = (0, _engine.Vector).create(!distance ? velocity : dx / distance * attractFactor, !distance ? velocity : dy / distance * attractFactor);
...
function clickAttract(container, enabledCb) {
    ...
    if (attract.clicking) {
        ...
        processAttract(container, mousePos, attractRadius, new (0, _engine.Circle)(mousePos.x, mousePos.y, attractRadius), (p)=>enabledCb(p));
...
},{"@tsparticles/engine":"ahMVX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lX4ev"], null, "parcelRequire6158")

//# sourceMappingURL=Attractor.ffd5e16a.js.map
