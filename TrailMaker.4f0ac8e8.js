...
})({"c17qJ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "8f94bae24f0ac8e8";
...
},{}],"8Coau":[function(require,module,exports) {
...
class TrailMaker extends (0, _engine.ExternalInteractorBase) {
    ...
    interact(delta) {
        ...
        const optDelay = trailOptions.delay * (0, _engine.millisecondsToSeconds) / this.container.retina.reduceFactor;
        ...
        if (mousePos) this._lastPosition = {
            ...mousePos
        };
    ...
    isEnabled(particle) {
        ...
        return mouse.clicking && mouse.inside && !!mouse.position && (0, _engine.isInArray)(trailMode, events.onClick.mode) || mouse.inside && !!mouse.position && (0, _engine.isInArray)(trailMode, events.onHover.mode);
    }
    loadModeOptions(options, ...sources) {
        if (!options.trail) options.trail = new (0, _trailJs.Trail)();
        for (const source of sources)options.trail.load(source?.trail);
    }
    reset() {}
}

},{"@tsparticles/engine":"ahMVX","./Options/Classes/Trail.js":"4nC5F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["c17qJ"], null, "parcelRequire6158")

//# sourceMappingURL=TrailMaker.4f0ac8e8.js.map
