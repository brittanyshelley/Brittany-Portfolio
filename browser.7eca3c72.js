...
})({"9w7PC":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "27c6b9487eca3c72";
...
},{}],"2XFPb":[function(require,module,exports) {
...
async function loadExternalAttractInteraction(engine, refresh = true) {
    await engine.addInteractor("externalAttract", async (container)=>{
        const { Attractor  } = await require("48b23d1e3b13987d");
        return new Attractor(engine, container);
    }, refresh);
}

},{"48b23d1e3b13987d":"2lMFn","./Options/Classes/Attract.js":"9j4pK","./Options/Interfaces/IAttract.js":"aDw0b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2lMFn":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("3pJ8U") + "Attractor.ffd5e16a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("kAOlz"));

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}],"9j4pK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9w7PC"], null, "parcelRequire6158")

//# sourceMappingURL=browser.7eca3c72.js.map
