...
})({"7OKIt":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ff3f5ab5061d6daa";
...
},{}],"ds6pp":[function(require,module,exports) {
...
async function loadExternalGrabInteraction(engine, refresh = true) {
    await engine.addInteractor("externalGrab", async (container)=>{
        const { Grabber  } = await require("8323253282507381");
        return new Grabber(container);
    }, refresh);
}

},{"8323253282507381":"1uw1y","./Options/Classes/Grab.js":"kJyOq","./Options/Classes/GrabLinks.js":"8THiC","./Options/Interfaces/IGrab.js":"hbFFH","./Options/Interfaces/IGrabLinks.js":"crdH6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1uw1y":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("lUFVP") + "Grabber.331280ed.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("eR17G"));

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}],"kJyOq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7OKIt"], null, "parcelRequire6158")

//# sourceMappingURL=browser.061d6daa.js.map
